...
import {
  getNewsArticleServer,
  getProjectServer,
  listGalleryServer,
  listKeyFiguresServer,
  listNewsServer,
  listPartnersServer,
  listProjectsServer,
...
export const listProjects = createServerFn({ method: "GET" }).handler(
  async (): Promise<Project[]> => listProjectsServer(),
);
...
export const listNews = createServerFn({ method: "GET" }).handler(
  async (): Promise<NewsArticle[]> => listNewsServer(),
);
...
export const listGallery = createServerFn({ method: "GET" }).handler(
  async (): Promise<GalleryItem[]> => listGalleryServer(),
);

export const listPartners = createServerFn({ method: "GET" }).handler(
  async (): Promise<Partner[]> => listPartnersServer(),
);

export const listKeyFigures = createServerFn({ method: "GET" }).handler(
  async (): Promise<KeyFigure[]> => listKeyFiguresServer(),
);
